...
fkFac=ROOT.TFile.Open("RooUnfold/kFacTest.root")
unfold_mu=fkFac.Get("response_mu_invert")
unfold_mu_kFac=fkFac.Get("response_mu_kFac_invert")
unfold_el=fkFac.Get("response_el_invert")
unfold_el_kFac=fkFac.Get("response_el_kFac_invert")

plotDataMC(unfold_mu_kFac,unfold_mu,True,"kFac/o","kFac/w","dimuon","kFac_mu" )
plotDataMC(unfold_el_kFac,unfold_el,True,"kFac/o","kFac/w","dielectron","kFac_el" )

fUnscaled=ROOT.TFile.Open("RooUnfold/unfoldedMass.root")
unfoldedMass_mu=fUnscaled.Get("response_mu_invert")
unfoldedMass_el=fUnscaled.Get("response_el_invert")

plotDataMC(unfoldedMass_mu,unfoldedMass_el,True,"muon","electron","uncorrected ratio","Uncorrected" )
